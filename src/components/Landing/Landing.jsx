...
class Homepage extends Component {
    ...
    render() { 
        var { loading, topTrackArtwork, topTrack, topTrackLoaded, topTrackPreview, topArtist, topArtistTrack } = this.state;
        ...
        return (
            <div className="container">
                <TopTracks topTrackArtwork={topTrackArtwork} topTrack={topTrack} topTrackLoaded={topTrackLoaded} topTrackPreview={topTrackPreview} topArtist={topArtist} topArtistTrack={topArtistTrack}/>
